...
from src.nlp.nl.tokens import get_token_list, get_stem_list
...
def _find_entity_positions(normalized_text: str,
    ...
    we need to ensure that it is not dutch words appeared in a piece of text written in uppercase.
