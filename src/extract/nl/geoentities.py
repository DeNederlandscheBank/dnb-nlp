...
class NlGeoentitiesParser:
    # DF column - GeoAnnotation attribute
    default_annotation_columns = \
        [NlGeoentityColumn('Entity ID', '', 'entity_id'),
         NlGeoentityColumn('Entity Category', '', 'entity_category'),
         NlGeoentityColumn('', 'source', 'source'),
         NlGeoentityColumn('Dutch Name', '', 'name'),
         NlGeoentityColumn('Entity Name', '', 'name_en'),
         NlGeoentityColumn('Entity Priority', '', 'entity_priority'),
         NlGeoentityColumn('ISO-3166-2', '', 'iso_3166_2'),
         NlGeoentityColumn('ISO-3166-3', '', 'iso_3166_3'),
         NlGeoentityColumn('Alias', '', 'alias')]

    default_selecting_columns = ["Dutch Name",
                                 "ISO-3166-2",
                                 "ISO-3166-3",
                                 "Alias"]
    ...
    def get_geoentity_annotations(
                        ...
                        config: pd.DataFrame,
                        parse_columns: Union[List[str], Tuple[str]] = None,
                        result_columns: List[NlGeoentityColumn] = None,
                        preformed_entity: Union[dict, None] = None,
                        priority_sort_column: Union[str, None] = None,
                        priority_sort_ascending: bool = True,
                        cell_values_separator: Union[str, None] = ';',
